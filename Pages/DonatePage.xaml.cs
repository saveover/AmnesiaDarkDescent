...
public sealed partial class DonatePage : Page
{
    ...
    [
        ...
        new("Report an issue", new("https://github.com/saveover/AmnesiaDarkDescent/issues"), "Report an issue on GitHub"),
        new("Browse the code", new("https://github.com/saveover/AmnesiaDarkDescent"), "Browse the source on GitHub"),
    ];

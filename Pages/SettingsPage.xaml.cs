...
public sealed partial class SettingsPage : Page
{
    ...
    private async void ChooseBackupFolderButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            if (folderPath is not null)
            {
                ...
                bool isGameSaveFolder = BackupSettings.IsGameSaveFolder;
                if (isGameSaveFolder)
                {
    ...
    private async System.Threading.Tasks.Task ShowCloudFolderDialogAsync()
    {
        ...
        ContentDialog dialog = new()
        {
            ...
            Content =
                "The default game save folder may be synchronized with Steam Cloud and may be unintentionally restored after deletion by Steam. It is recommended to select a different folder for backup storage.",
            CloseButtonText = "OK",

# Contributing to SaveOver for Amnesia: The Dark Descent
...
- Search the [issues](https://github.com/saveover/AmnesiaDarkDescent/issues) and pull
...
```powershell
git clone https://github.com/YOUR-USERNAME/AmnesiaDarkDescent.git
cd AmnesiaDarkDescent
git remote add upstream https://github.com/saveover/AmnesiaDarkDescent.git
```
...
Reject values outside the range accepted by Amnesia before updating

...
/// <summary>Keeps integer save fields integer-backed even though NumberBox exposes doubles.</summary>
public sealed partial class Int32NumberConverter : IValueConverter
{
    ...
    public object ConvertBack(object value, Type targetType, object parameter, string language) =>
        value is double number && double.IsFinite(number)
            ? int.CreateSaturating(Math.Round(number, MidpointRounding.AwayFromZero))
